...
class BigToSmall extends StatefulWidget {
  const BigToSmall({super.key});

  @override
  State<BigToSmall> createState() => _BigToSmallState();
}

class _BigToSmallState extends State<BigToSmall> {
  ...
  String category = "Descending Order";
  ...
  void Number(int number) {
    setState(() {
      ...
      CorrectNumber.sort((a, b) => b.compareTo(a));
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  isButton1Pressed ? Colors.grey : Colors.white,
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  isButton2Pressed ? Colors.grey : Colors.white,
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(60),
                              )),
                          child: Text(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  isButton3Pressed ? Colors.grey : Colors.white,
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(60),
                              )),
                          child: Text(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  isButton4Pressed ? Colors.grey : Colors.white,
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(60),
                              )),
                          child: Text(
